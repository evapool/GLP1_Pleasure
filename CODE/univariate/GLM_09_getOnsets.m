...
obese = fullfile(homedir, 'sub-obese*');
...
for s = 1:length(session)
    ...
    for  i=1:length(subj)
        ...
        if exist(full_path, 'file')
            ...
            disp (['****** PARTICIPANT REJ: ' subjX ' **** session ' sessionX ' ****' ]);
            subjRej = [subjRej; [sub '-' sessionX]];
...
%         
        ...
        modulators.taste.conc.lik = modulators.taste.conc.lik - cent_lik;
...
%         modulators.taste.conc.fam = modulators.taste.conc.fam(Idx,:);
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        name = {'trialstart'; 'taste'; 'liking'; 'intensity'; 'familiarity'};
...
save(fullfile(mdldir, char(task), ana_name, 'subj_noevents'), 'subjRej')
